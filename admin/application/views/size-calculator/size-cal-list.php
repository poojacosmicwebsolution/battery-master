				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Sizes Calculator</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Size Calculator Master</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Size_calculator/add">Add Size</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Size Master List</h6>
											<p class="text-muted card-sub-title">This are all Size you added</p>
										</div>
											...
											<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-25p">Band Size</th>
														<th class="wd-25p">Size </th>
														<th class="wd-25p">Bust Size</th>
														<th class="wd-25p">Cup Size</th>
												...
												<tbody>
													...
													<tr>
														<td><?php echo $a['id']; ?></td>
														<td><?php echo $a['band_size']; ?></td>
														<td><?php echo $a['b_size']; ?></td>
														<td><?php echo $a['bust_size']; ?></td>
														<td><?php echo $a['cup']; ?></td>
														
														<td>
																		<a href="<?php echo base_url(); ?>Size_calculator/delete/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Size_calculator/edit/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
