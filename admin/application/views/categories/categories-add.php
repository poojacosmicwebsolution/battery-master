												...
												<div class="row row-sm">
													...
													<div class="col-md-6">
														<div class="form-group" >
															...
															<input type="text" readonly="" class="form-control " name="path" id="path"  value="<?php if(isset($category)){ echo $category['cat_img'];} ?>" >
															<br>
													...
													<div class="col-md-6">
														<div class="form-group row justify-content-center mb-0">
															...
															<img  id="img-preview" src="<?php echo base_url().$category['cat_img']; ?>" height="250">
															 	<?php }else{ ?>
