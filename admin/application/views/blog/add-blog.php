										...
										<div class="card custom-card">
											<div class="card-body">
												<div class="row row-sm">
													...
													<div class="col-md-6">
														<div class="form-group" >
															<p class="mg-b-10">Main Image Path</p>
															<input type="text" readonly="" class="form-control " name="path" id="path"  value="<?php if(isset($blogs)){ echo $blogs['image'];} ?>" >
															<br>
															<a class="btn ripple btn-secondary" data-target="#scrollmodal" data-toggle="modal" onclick="setCurrentFlag('main')" href="">Select Image</a>
														</div>
													...
													<div class="col-md-6">
														<div class="form-group" >
															<p class="mg-b-10">Thumbnail Image </p>
															<input type="text" readonly="" class="form-control " name="thumbnail" id="thumbnail"  value="<?php if(isset($blogs)){ echo $blogs['thumbnail'];} ?>" >
															<br>
															<a class="btn ripple btn-secondary" data-target="#scrollmodal" data-toggle="modal" onclick="setCurrentFlag('thumbnail')" href="">Select Image</a>
														</div>
													...
													<div class="col-md-6">
														<div class="form-group row justify-content-center mb-0">
															...
															<img  id="img-preview1" src="<?php echo base_url().$blogs['thumbnail']; ?>" height="250">
															 	<?php }else{ ?>
															<img src="" id="img-preview1" style="display:none" height="250">
															 	<?php } ?>
														</div>
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea rows="10" class="form-control " name="description" id="product_description" placeholder="Description"  ><?php if(isset($blogs)){ echo $blogs['description'];} ?></textarea>
		...
		<script type="text/javascript">
			...
			function selectImage(id,path){
				...
				if(flg == 'main'){
					...
					$("#img-preview").show();
					$("#path").val(path);
				}else if(flg == 'thumbnail'){
					$("#img-preview1").attr("src","<?php echo base_url(); ?>"+path);
					$("#img-preview1").show();
					// $("#img-preview").show();
					$("#thumbnail").val(path);
				}
