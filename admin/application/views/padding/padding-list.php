					...
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Padding Master</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Padding_master/add">Add Padding</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Padding Master List</h6>
											<p class="text-muted card-sub-title">This are all Padding you added</p>
										</div>
										<div class="table-responsive">
											<table class="table" id="example1">
												...
												<tbody>
													<?php foreach($padding as $a){ ?>
													<tr>
														<td><?php echo $a['id']; ?></td>
														<td><?php echo $a['padding_name']; ?></td>
														<td><?php echo $a['display_order']; ?></td>
														<td>
																		<a href="<?php echo base_url(); ?>Padding_master/delete/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Padding_master/edit/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
