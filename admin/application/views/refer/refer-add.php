				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Referal Settings</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
									<li class="breadcrumb-item active"  aria-current="page">Referal Settings</li>
						...
						<div class="row row-sm">
							<div class="col-md-12">
								...
								<div class="col-lg-12">
									<form action="<?php echo base_url(); ?>" method="POST" enctype="multipart/form-data" id="myForm">
