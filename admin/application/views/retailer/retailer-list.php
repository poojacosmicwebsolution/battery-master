					...
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Retailer list</li>
								</ol>
							</div>
							<div class="d-flex">
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Retailer List</h6>
											...
											<table class="table orders" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-25p">Gst</th>
														<th class="wd-25p">Stock</th>
														<th class="wd-25p">Payment</th>
												...
												<tbody>
													...
													foreach($retailer as $dis){ ?>
													<tr>
														<td><?php echo $dis['id']; ?></td>
														<td><?php echo $dis['company_name']; ?></td>
														<td><?php echo $dis['company_add']; ?></td>
														<td><?php echo $dis['gst']; ?></td>
														<td><?php echo $dis['stock']; ?></td>
														<td><?php echo $dis['payment']; ?></td>
												
														<td><?php echo $dis['know']; ?></td>
													
														<td>
														
														<a href="<?php echo base_url() ?>retailer/delete/<?php echo $dis['id']?>" class="btn btn-danger btn-sm" >Delete</a>
