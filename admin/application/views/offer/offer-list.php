				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Offers</h2>
								<ol class="breadcrumb">
							...
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<!--<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>offer/add">Add Offer</a>-->
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Offers List</h6>
											<p class="text-muted card-sub-title">This are all Offers you added</p>
										</div>
											...
											<table class="table" id="example2">
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $off['title']; ?></td>
														<td><?php echo $off['image']; ?></td>
														<td>
															<!--<a href="<?php echo base_url(); ?>Offer/delete/<?php echo $off['id']; ?>" class="btn btn-danger btn-sm">Delete</a>-->
														    <a href="<?php echo base_url(); ?>Offer/edit/<?php echo $off['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                                                        </td>
													</tr>
													<?php } ?>
