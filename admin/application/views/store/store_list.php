					...
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Store Locator list</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Store/add">Add Store</a>
								</div>
							</div>
						...
						<div class="row row-sm">
								...
								<div class="card custom-card">
									<div class="card-body">
										<div>
											<h6 class="main-content-label mb-1">Store List</h6>
											...
											<table class="table" id="example1">
												<thead>
													<tr>
														...
														<th class="wd-25p">lat</th>
														<th class="wd-25p">long</th>
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $c['log']; ?></td>

														<td>
															<a href="<?php echo base_url(); ?>Store/delete/<?php echo $c['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
															<a href="<?php echo base_url(); ?>Store/edit/<?php echo $c['id']; ?>" class="btn btn-info btn-sm">Edit</a>
