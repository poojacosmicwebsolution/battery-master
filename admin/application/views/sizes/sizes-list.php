				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Sizes</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Size Master</li>
								</ol>
							</div>
							<div class="d-flex">
								<div class="justify-content-center">
									...
									<a  class="btn btn-primary my-2 btn-icon-text" href="<?php echo base_url(); ?>Size_master/add">Add Size</a>
								</div>
							</div>
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													<tr>
														...
														<td>
																		<a href="<?php echo base_url(); ?>Size_master/delete/<?php echo $a['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
																		<a href="<?php echo base_url(); ?>Size_master/edit/<?php echo $a['id']; ?>" class="btn btn-info btn-sm">Edit</a>
